package com.vlntdds.developlayground.permissions;
...
public class RuntimePermissionsActivity extends AppCompatActivity {
    ...
    public static void startActivity(@NonNull final Fragment fragment,
        ...
        final Intent intent = new Intent(fragment.getActivity(), RuntimePermissionsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!permissionRationaleNeeded.isEmpty()) {
            String message = getString(R.string.permissions_request);
    ...
    private ArrayList<String> getPermissionNeeded(@NonNull final ArrayList<String> reqPermissions) {
        ...
        for (String reqPermission : reqPermissions) {
            if (ContextCompat.checkSelfPermission(RuntimePermissionsActivity.this, reqPermission)
    ...
    private ArrayList<String> getPermissionRationaleNeeded(@NonNull final ArrayList<String> permissionsNeeded) {
        ...
        for (String permissionNeeded : permissionsNeeded) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                    RuntimePermissionsActivity.this, permissionNeeded)) {
        ...
        new AlertDialog.Builder(RuntimePermissionsActivity.this)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        RuntimePermissionsActivity.this.requestForPermission(permissions);
                    }
                })
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        RuntimePermissionsActivity.this.sendResult(false);
                    }
                })
    ...
    private void requestForPermission(final String[] permissions) {
        ActivityCompat.requestPermissions(RuntimePermissionsActivity.this, permissions, REQUEST_CODE);
    }
